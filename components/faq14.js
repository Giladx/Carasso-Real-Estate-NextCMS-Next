...
FAQ14.defaultProps = {
  ...
  faq3Question: 'מהי חשיבות האהבה לבישול ולאירוח במרחבי משותפים?',
  heading2: 'Still have a question?',
  faq2Question: 'מהו תהליך ההתחדשות העירונית ואילו יתרונות יש בו?',
  heading1: 'FAQs',
  action2: 'Email us',
  action1: 'Contact',
  content1:
    'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.',
  faq4Question: 'איך אני יכול להתעדכן בפרויקטים החדשים בקריית אונו?',
  faq5Question: 'איך אני יכול לשאול שאלה אחרת שלא מצאתי כאן?',
}
