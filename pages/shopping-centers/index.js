...
import shoppingCentersPageInitialPropsTq3iResource from '../../resources/shopping-centers-page-initial-props-tq_3i'
...
export async function getStaticProps(context) {
  try {
    const response = await shoppingCentersPageInitialPropsTq3iResource({
      ...context?.params,
    })
    if (!response) {
      return {
