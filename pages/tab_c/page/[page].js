...
import tabCPageInitialPropsTqPQResource from '../../../resources/tab_c-page-initial-props-tq_p-q'
import tabCPageInitialPathsTqGwResource from '../../../resources/tab_c-page-initial-paths-tq_gw'
...
export async function getStaticProps(context) {
  try {
    const response = await tabCPageInitialPropsTqPQResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await tabCPageInitialPathsTqGwResource({
      content_type: 'tabC',
    })
