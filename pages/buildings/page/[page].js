...
import buildingsPageInitialPropsTq0jResource from '../../../resources/buildings-page-initial-props-tq_0j'
import buildingsPageInitialPathsTqB4Resource from '../../../resources/buildings-page-initial-paths-tq_b4'
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTq0jResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await buildingsPageInitialPathsTqB4Resource({
