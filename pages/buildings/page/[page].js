...
import buildingsPageInitialPathsTq5wResource from '../../../resources/buildings-page-initial-paths-tq_5w'
...
export async function getStaticPaths() {
  try {
    const response = await buildingsPageInitialPathsTq5wResource({
