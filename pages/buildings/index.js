...
import buildingsPageInitialPropsTqZ0Resource from '../../resources/buildings-page-initial-props-tq_z0'
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTqZ0Resource({
      ...context?.params,
    })
    if (!response) {
      return {
