...
import buildingsPageInitialPropsTqAXResource from '../../resources/buildings-page-initial-props-tq_a-x'
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTqAXResource({
      ...context?.params,
    })
    if (!response) {
      return {
