...
import buildingsPageInitialPropsTqTmResource from '../../resources/buildings-page-initial-props-tq_tm'
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTqTmResource({
      ...context?.params,
    })
    if (!response) {
      return {
