...
import tabDPageInitialPropsTqPiResource from '../../../resources/tab_d-page-initial-props-tq_pi'
import tabDPageInitialPathsTqRCResource from '../../../resources/tab_d-page-initial-paths-tq_r-c'
...
export async function getStaticProps(context) {
  try {
    const response = await tabDPageInitialPropsTqPiResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await tabDPageInitialPathsTqRCResource({
      content_type: 'tabD',
    })
