...
import apartmentsPageInitialPropsTqW5Resource from '../../resources/apartments-page-initial-props-tq_w5'
...
export async function getStaticProps(context) {
  try {
    const response = await apartmentsPageInitialPropsTqW5Resource({
      ...context?.params,
    })
    if (!response) {
      return {
