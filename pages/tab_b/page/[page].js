...
import tabBPageInitialPropsTqA9Resource from '../../../resources/tab_b-page-initial-props-tq_a9'
import tabBPageInitialPathsTqClResource from '../../../resources/tab_b-page-initial-paths-tq_cl'
...
export async function getStaticProps(context) {
  try {
    const response = await tabBPageInitialPropsTqA9Resource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await tabBPageInitialPathsTqClResource({
      content_type: 'tabB',
    })
