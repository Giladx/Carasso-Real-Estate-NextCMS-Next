...
import tabAPageInitialPropsTqPgResource from '../../../resources/tab_a-page-initial-props-tq_pg'
import tabAPageInitialPathsTqZResource from '../../../resources/tab_a-page-initial-paths-tq_z-'
...
export async function getStaticProps(context) {
  try {
    const response = await tabAPageInitialPropsTqPgResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await tabAPageInitialPathsTqZResource({
      content_type: 'tabs',
    })
